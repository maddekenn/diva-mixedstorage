...
public class GuestUserStorageProviderSpy2 implements GuestUserStorageProvider {
	Map<String, String> initInfo;
	private UserStorageSpy guestUserStorageSpy = new UserStorageSpy();
