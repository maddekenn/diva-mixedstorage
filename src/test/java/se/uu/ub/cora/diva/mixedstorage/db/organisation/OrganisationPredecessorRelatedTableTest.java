...
public class OrganisationPredecessorRelatedTableTest {
	...
	@Test
	public void testOnePredecessorInDbButNoNameInDataGroup() {
		DataGroup organisation = createDataGroupWithId("678");
	...
	private void addRowToReturnFromSpy(int organisationId, int parentId) {
		...
		rowToReturn.put("organisation_predecessor_id", parentId);
	...
	private void addPredecessor(DataGroup organisation, String parentId, String repeatId) {
		...
		predecessorGroup.addChild(parentLink);
